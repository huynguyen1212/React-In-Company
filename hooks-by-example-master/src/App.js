    ...
    <Router>
      <div className="main">
        <div className="sync-async">
          <a
            css={css`
              font-weight: ${(!mode || mode === "sync") && "bold"};
            `}
            onClick={() => {
          ...
          <a
            css={css`
              font-weight: ${mode === "concurrent" && "bold"};
            `}
            onClick={() => {
        ...
        <nav className="sidebar">
          <div className="item">
            ...
            <span>
              Panels scroll into view if not fully visible when toggled. Using{" "}
              <pre>useEffect</pre>, <pre>useRef</pre>.
            </span>
          </div>
          <div className="item">
            ...
            <span>
              Pass state deeper using context, then read it using{" "}
              <pre>useContext</pre>. Heavily inspired by <pre>formik</pre>.
            </span>
          </div>
          <div className="item">
            ...
            <span>
              Multiple <pre>useEffects</pre> are allowed.
            </span>
          </div>
          <div className="item">
            ...
            <span>
              Look mum, <pre>useReducer</pre> is almost Redux!
            </span>
          </div>
          <div className="item">
          ...
          <div className="item">
            ...
            <span css={{ display: "flex" }}>
              <Link className="link" to="/concurrent1">
                One
              </Link>
              ,{" "}
              <Link className="link" to="/concurrent2">
                Two
              </Link>
              ,{" "}
              <Link className="link" to="/concurrent3">
                Three
              </Link>
            </span>
          </div>
